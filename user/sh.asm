...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	4fe58593          	add	a1,a1,1278 # 1510 <updateNode+0x44>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	4b858593          	add	a1,a1,1208 # 1518 <updateNode+0x4c>
      68:	4509                	li	a0,2
      6a:	00001097          	auipc	ra,0x1
      6e:	152080e7          	jalr	338(ra) # 11bc <fprintf>
  exit(1);
      72:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	48650513          	add	a0,a0,1158 # 1520 <updateNode+0x54>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	55a70713          	add	a4,a4,1370 # 1620 <updateNode+0x154>
    ...
    panic("runcmd");
      ...
      e4:	44850513          	add	a0,a0,1096 # 1528 <updateNode+0x5c>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	42e58593          	add	a1,a1,1070 # 1530 <updateNode+0x64>
     10a:	4509                	li	a0,2
     10c:	00001097          	auipc	ra,0x1
     110:	0b0080e7          	jalr	176(ra) # 11bc <fprintf>
  exit(0);
     114:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     152:	3f258593          	add	a1,a1,1010 # 1540 <updateNode+0x74>
     156:	4509                	li	a0,2
     158:	00001097          	auipc	ra,0x1
     15c:	064080e7          	jalr	100(ra) # 11bc <fprintf>
      exit(1);
     160:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     1e8:	36c50513          	add	a0,a0,876 # 1550 <updateNode+0x84>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     28a:	01c080e7          	jalr	28(ra) # 12a2 <malloc>
     28e:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d4:	fd2080e7          	jalr	-46(ra) # 12a2 <malloc>
     2d8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32e:	f78080e7          	jalr	-136(ra) # 12a2 <malloc>
     332:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     334:	4661                	li	a2,24
     336:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b6:	ef0080e7          	jalr	-272(ra) # 12a2 <malloc>
     3ba:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3bc:	4641                	li	a2,16
     3be:	4581                	li	a1,0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	fc2b8b93          	add	s7,s7,-62 # 1578 <updateNode+0xac>
  ...
  while(peek(ps, es, "<>")){
     ...
     5cc:	f9050513          	add	a0,a0,-112 # 1558 <updateNode+0x8c>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6b4:	ed060613          	add	a2,a2,-304 # 1580 <updateNode+0xb4>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6e4:	ec0b0b13          	add	s6,s6,-320 # 15a0 <updateNode+0xd4>
  ...
  return ret;
     ...
     71e:	e6e50513          	add	a0,a0,-402 # 1588 <updateNode+0xbc>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     780:	e1450513          	add	a0,a0,-492 # 1590 <updateNode+0xc4>
...
000000000000079a <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ba:	df260613          	add	a2,a2,-526 # 15a8 <updateNode+0xdc>
     7be:	85ce                	mv	a1,s3
     7c0:	854a                	mv	a0,s2
...
0000000000000808 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     82a:	d8aa0a13          	add	s4,s4,-630 # 15b0 <updateNode+0xe4>
  ...
  if(peek(ps, es, ";")){
     ...
     860:	d5c60613          	add	a2,a2,-676 # 15b8 <updateNode+0xec>
     864:	85ce                	mv	a1,s3
     866:	854a                	mv	a0,s2
...
00000000000008b0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c6:	cbe60613          	add	a2,a2,-834 # 1580 <updateNode+0xb4>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f6:	cde60613          	add	a2,a2,-802 # 15d0 <updateNode+0x104>
     8fa:	85ca                	mv	a1,s2
     8fc:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     938:	c8c50513          	add	a0,a0,-884 # 15c0 <updateNode+0xf4>
     93c:	fffff097          	auipc	ra,0xfffff
     940:	71a080e7          	jalr	1818(ra) # 56 <panic>
    panic("syntax - missing )");
     944:	00001517          	auipc	a0,0x1
     948:	c9450513          	add	a0,a0,-876 # 15d8 <updateNode+0x10c>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     974:	cc870713          	add	a4,a4,-824 # 1638 <updateNode+0x16c>
...
00000000000009ec <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a20:	bd460613          	add	a2,a2,-1068 # 15f0 <updateNode+0x124>
     a24:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a56:	ba658593          	add	a1,a1,-1114 # 15f8 <updateNode+0x12c>
     a5a:	4509                	li	a0,2
     a5c:	00000097          	auipc	ra,0x0
     a60:	760080e7          	jalr	1888(ra) # 11bc <fprintf>
    panic("syntax");
     a64:	00001517          	auipc	a0,0x1
     a68:	b2450513          	add	a0,a0,-1244 # 1588 <updateNode+0xbc>
...
0000000000000a74 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a88:	b8448493          	add	s1,s1,-1148 # 1608 <updateNode+0x13c>
     a8c:	4589                	li	a1,2
     a8e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b3e:	ad658593          	add	a1,a1,-1322 # 1610 <updateNode+0x144>
     b42:	4509                	li	a0,2
     b44:	00000097          	auipc	ra,0x0
     b48:	678080e7          	jalr	1656(ra) # 11bc <fprintf>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     c78:	1d6080e7          	jalr	470(ra) # e4a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     cca:	1ac080e7          	jalr	428(ra) # e72 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     cda:	1b4080e7          	jalr	436(ra) # e8a <fstat>
     cde:	892a                	mv	s2,a0
  close(fd);
     ce0:	8526                	mv	a0,s1
     ce2:	00000097          	auipc	ra,0x0
     ce6:	178080e7          	jalr	376(ra) # e5a <close>
  return r;
}
     cea:	854a                	mv	a0,s2
...
0000000000000dee <initlock>:

// Initialize the spinlock
void initlock(struct spinlock_u *lk) {
     dee:	1141                	add	sp,sp,-16
     df0:	e422                	sd	s0,8(sp)
     df2:	0800                	add	s0,sp,16
  lk->locked = 0;
     df4:	00052023          	sw	zero,0(a0)
}
     df8:	6422                	ld	s0,8(sp)
     dfa:	0141                	add	sp,sp,16
     dfc:	8082                	ret

0000000000000dfe <acquire>:
...
void acquire(struct spinlock_u *lk) {
  ...
  while (__sync_lock_test_and_set(&lk->locked, 1) != 0)
     e04:	4705                	li	a4,1
     e06:	87ba                	mv	a5,a4
     e08:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
     e0c:	2781                	sext.w	a5,a5
     e0e:	ffe5                	bnez	a5,e06 <acquire+0x8>
    ; // Spin until the lock is acquired
}
     e10:	6422                	ld	s0,8(sp)
     e12:	0141                	add	sp,sp,16
     e14:	8082                	ret

0000000000000e16 <release>:

// Release the spinlock
void release(struct spinlock_u *lk) {
     e16:	1141                	add	sp,sp,-16
     e18:	e422                	sd	s0,8(sp)
     e1a:	0800                	add	s0,sp,16
  __sync_lock_release(&lk->locked);
     e1c:	0f50000f          	fence	iorw,ow
     e20:	0805202f          	amoswap.w	zero,zero,(a0)
}
     e24:	6422                	ld	s0,8(sp)
...
0000000000000eda <rcureadunlock>:
...
0000000000000eea <thread_create>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     f56:	0805c963          	bltz	a1,fe8 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f6a:	74a50513          	add	a0,a0,1866 # 16b0 <digits>
     f6e:	883a                	mv	a6,a4
     f70:	2705                	addw	a4,a4,1
     f72:	02c5f7bb          	remuw	a5,a1,a2
     f76:	1782                	sll	a5,a5,0x20
     f78:	9381                	srl	a5,a5,0x20
     ...
     f8c:	0685                	add	a3,a3,1
     f8e:	fec7f0e3          	bgeu	a5,a2,f6e <printint+0x2a>
  if(neg)
     f92:	00088c63          	beqz	a7,faa <printint+0x66>
    buf[i++] = '-';
     f96:	fd070793          	add	a5,a4,-48
     f9a:	00878733          	add	a4,a5,s0
     f9e:	02d00793          	li	a5,45
     fa2:	fef70823          	sb	a5,-16(a4)
     fa6:	0028071b          	addw	a4,a6,2

  while(--i >= 0)
     faa:	02e05863          	blez	a4,fda <printint+0x96>
     fae:	fc040793          	add	a5,s0,-64
     fb2:	00e78933          	add	s2,a5,a4
     fb6:	fff78993          	add	s3,a5,-1
     fba:	99ba                	add	s3,s3,a4
     fbc:	377d                	addw	a4,a4,-1
     fbe:	1702                	sll	a4,a4,0x20
     fc0:	9301                	srl	a4,a4,0x20
     fc2:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     fc6:	fff94583          	lbu	a1,-1(s2)
     fca:	8526                	mv	a0,s1
     fcc:	00000097          	auipc	ra,0x0
     fd0:	f56080e7          	jalr	-170(ra) # f22 <putc>
  while(--i >= 0)
     fd4:	197d                	add	s2,s2,-1
     fd6:	ff3918e3          	bne	s2,s3,fc6 <printint+0x82>
}
     fda:	70e2                	ld	ra,56(sp)
     fdc:	7442                	ld	s0,48(sp)
     fde:	74a2                	ld	s1,40(sp)
     fe0:	7902                	ld	s2,32(sp)
     fe2:	69e2                	ld	s3,24(sp)
     fe4:	6121                	add	sp,sp,64
     fe6:	8082                	ret
    x = -xx;
     fe8:	40b005bb          	negw	a1,a1
    neg = 1;
     fec:	4885                	li	a7,1
    x = -xx;
     fee:	bf85                	j	f5e <printint+0x1a>

0000000000000ff0 <vprintf>:
}
...
{
     ff0:	715d                	add	sp,sp,-80
     ff2:	e486                	sd	ra,72(sp)
     ff4:	e0a2                	sd	s0,64(sp)
     ff6:	fc26                	sd	s1,56(sp)
     ff8:	f84a                	sd	s2,48(sp)
     ffa:	f44e                	sd	s3,40(sp)
     ffc:	f052                	sd	s4,32(sp)
     ffe:	ec56                	sd	s5,24(sp)
    1000:	e85a                	sd	s6,16(sp)
    1002:	e45e                	sd	s7,8(sp)
    1004:	e062                	sd	s8,0(sp)
    1006:	0880                	add	s0,sp,80
  char *s;
  int c, i, state;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    100c:	18090c63          	beqz	s2,11a4 <vprintf+0x1b4>
    1010:	8aaa                	mv	s5,a0
    1012:	8bb2                	mv	s7,a2
    1014:	00158493          	add	s1,a1,1
  state = 0;
    1018:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    101e:	4b55                	li	s6,21
    1020:	a839                	j	103e <vprintf+0x4e>
        putc(fd, c);
    1022:	85ca                	mv	a1,s2
    1024:	8556                	mv	a0,s5
    1026:	00000097          	auipc	ra,0x0
    102a:	efc080e7          	jalr	-260(ra) # f22 <putc>
    102e:	a019                	j	1034 <vprintf+0x44>
    } else if(state == '%'){
    1030:	01498d63          	beq	s3,s4,104a <vprintf+0x5a>
  for(i = 0; fmt[i]; i++){
    1034:	0485                	add	s1,s1,1
    1036:	fff4c903          	lbu	s2,-1(s1)
    103a:	16090563          	beqz	s2,11a4 <vprintf+0x1b4>
    if(state == 0){
    103e:	fe0999e3          	bnez	s3,1030 <vprintf+0x40>
      if(c == '%'){
    1042:	ff4910e3          	bne	s2,s4,1022 <vprintf+0x32>
        state = '%';
    1046:	89d2                	mv	s3,s4
    1048:	b7f5                	j	1034 <vprintf+0x44>
      if(c == 'd'){
    104a:	13490263          	beq	s2,s4,116e <vprintf+0x17e>
    104e:	f9d9079b          	addw	a5,s2,-99
    1052:	0ff7f793          	zext.b	a5,a5
    1056:	12fb6563          	bltu	s6,a5,1180 <vprintf+0x190>
    105a:	f9d9079b          	addw	a5,s2,-99
    105e:	0ff7f713          	zext.b	a4,a5
    1062:	10eb6f63          	bltu	s6,a4,1180 <vprintf+0x190>
    1066:	00271793          	sll	a5,a4,0x2
    106a:	00000717          	auipc	a4,0x0
    106e:	5ee70713          	add	a4,a4,1518 # 1658 <updateNode+0x18c>
    1072:	97ba                	add	a5,a5,a4
    1074:	439c                	lw	a5,0(a5)
    1076:	97ba                	add	a5,a5,a4
    1078:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    107a:	008b8913          	add	s2,s7,8
    107e:	4685                	li	a3,1
    1080:	4629                	li	a2,10
    1082:	000ba583          	lw	a1,0(s7)
    1086:	8556                	mv	a0,s5
    1088:	00000097          	auipc	ra,0x0
    108c:	ebc080e7          	jalr	-324(ra) # f44 <printint>
    1090:	8bca                	mv	s7,s2
      } else {
      ...
      state = 0;
    1092:	4981                	li	s3,0
    1094:	b745                	j	1034 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
    1096:	008b8913          	add	s2,s7,8
    109a:	4681                	li	a3,0
    109c:	4629                	li	a2,10
    109e:	000ba583          	lw	a1,0(s7)
    10a2:	8556                	mv	a0,s5
    10a4:	00000097          	auipc	ra,0x0
    10a8:	ea0080e7          	jalr	-352(ra) # f44 <printint>
    10ac:	8bca                	mv	s7,s2
      state = 0;
    10ae:	4981                	li	s3,0
    10b0:	b751                	j	1034 <vprintf+0x44>
    ...
    10c4:	e84080e7          	jalr	-380(ra) # f44 <printint>
    10c8:	8bca                	mv	s7,s2
      state = 0;
    10ca:	4981                	li	s3,0
    10cc:	b7a5                	j	1034 <vprintf+0x44>
        printptr(fd, va_arg(ap, uint64));
    10ce:	008b8c13          	add	s8,s7,8
    10d2:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    10d6:	03000593          	li	a1,48
    10da:	8556                	mv	a0,s5
    10dc:	00000097          	auipc	ra,0x0
    10e0:	e46080e7          	jalr	-442(ra) # f22 <putc>
  putc(fd, 'x');
    10e4:	07800593          	li	a1,120
    10e8:	8556                	mv	a0,s5
    10ea:	00000097          	auipc	ra,0x0
    10ee:	e38080e7          	jalr	-456(ra) # f22 <putc>
    10f2:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    10f4:	00000b97          	auipc	s7,0x0
    10f8:	5bcb8b93          	add	s7,s7,1468 # 16b0 <digits>
    10fc:	03c9d793          	srl	a5,s3,0x3c
    1100:	97de                	add	a5,a5,s7
    1102:	0007c583          	lbu	a1,0(a5)
    1106:	8556                	mv	a0,s5
    1108:	00000097          	auipc	ra,0x0
    110c:	e1a080e7          	jalr	-486(ra) # f22 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1110:	0992                	sll	s3,s3,0x4
    1112:	397d                	addw	s2,s2,-1
    1114:	fe0914e3          	bnez	s2,10fc <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    1118:	8be2                	mv	s7,s8
      state = 0;
    111a:	4981                	li	s3,0
    111c:	bf21                	j	1034 <vprintf+0x44>
        s = va_arg(ap, char*);
    111e:	008b8993          	add	s3,s7,8
    1122:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    1126:	02090163          	beqz	s2,1148 <vprintf+0x158>
        while(*s != 0){
    112a:	00094583          	lbu	a1,0(s2)
    112e:	c9a5                	beqz	a1,119e <vprintf+0x1ae>
          putc(fd, *s);
    1130:	8556                	mv	a0,s5
    1132:	00000097          	auipc	ra,0x0
    1136:	df0080e7          	jalr	-528(ra) # f22 <putc>
          s++;
    113a:	0905                	add	s2,s2,1
        while(*s != 0){
    113c:	00094583          	lbu	a1,0(s2)
    1140:	f9e5                	bnez	a1,1130 <vprintf+0x140>
        s = va_arg(ap, char*);
    1142:	8bce                	mv	s7,s3
      state = 0;
    1144:	4981                	li	s3,0
    1146:	b5fd                	j	1034 <vprintf+0x44>
          s = "(null)";
    1148:	00000917          	auipc	s2,0x0
    114c:	50890913          	add	s2,s2,1288 # 1650 <updateNode+0x184>
        while(*s != 0){
    1150:	02800593          	li	a1,40
    1154:	bff1                	j	1130 <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
    1156:	008b8913          	add	s2,s7,8
    115a:	000bc583          	lbu	a1,0(s7)
    115e:	8556                	mv	a0,s5
    1160:	00000097          	auipc	ra,0x0
    1164:	dc2080e7          	jalr	-574(ra) # f22 <putc>
    1168:	8bca                	mv	s7,s2
      state = 0;
    116a:	4981                	li	s3,0
    116c:	b5e1                	j	1034 <vprintf+0x44>
        putc(fd, c);
    116e:	02500593          	li	a1,37
    1172:	8556                	mv	a0,s5
    1174:	00000097          	auipc	ra,0x0
    1178:	dae080e7          	jalr	-594(ra) # f22 <putc>
      state = 0;
    117c:	4981                	li	s3,0
    117e:	bd5d                	j	1034 <vprintf+0x44>
        putc(fd, '%');
    1180:	02500593          	li	a1,37
    1184:	8556                	mv	a0,s5
    1186:	00000097          	auipc	ra,0x0
    118a:	d9c080e7          	jalr	-612(ra) # f22 <putc>
        putc(fd, c);
    118e:	85ca                	mv	a1,s2
    1190:	8556                	mv	a0,s5
    1192:	00000097          	auipc	ra,0x0
    1196:	d90080e7          	jalr	-624(ra) # f22 <putc>
      state = 0;
    119a:	4981                	li	s3,0
    119c:	bd61                	j	1034 <vprintf+0x44>
        s = va_arg(ap, char*);
    119e:	8bce                	mv	s7,s3
      state = 0;
    11a0:	4981                	li	s3,0
    11a2:	bd49                	j	1034 <vprintf+0x44>
    }
  }
}
    11a4:	60a6                	ld	ra,72(sp)
    11a6:	6406                	ld	s0,64(sp)
    11a8:	74e2                	ld	s1,56(sp)
    11aa:	7942                	ld	s2,48(sp)
    11ac:	79a2                	ld	s3,40(sp)
    11ae:	7a02                	ld	s4,32(sp)
    11b0:	6ae2                	ld	s5,24(sp)
    11b2:	6b42                	ld	s6,16(sp)
    11b4:	6ba2                	ld	s7,8(sp)
    11b6:	6c02                	ld	s8,0(sp)
    11b8:	6161                	add	sp,sp,80
    11ba:	8082                	ret

00000000000011bc <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    11bc:	715d                	add	sp,sp,-80
    11be:	ec06                	sd	ra,24(sp)
    11c0:	e822                	sd	s0,16(sp)
    11c2:	1000                	add	s0,sp,32
    11c4:	e010                	sd	a2,0(s0)
    11c6:	e414                	sd	a3,8(s0)
    11c8:	e818                	sd	a4,16(s0)
    11ca:	ec1c                	sd	a5,24(s0)
    11cc:	03043023          	sd	a6,32(s0)
    11d0:	03143423          	sd	a7,40(s0)
  va_list ap;
  ...
  vprintf(fd, fmt, ap);
    ...
    11de:	e16080e7          	jalr	-490(ra) # ff0 <vprintf>
}
    11e2:	60e2                	ld	ra,24(sp)
    11e4:	6442                	ld	s0,16(sp)
    11e6:	6161                	add	sp,sp,80
    11e8:	8082                	ret

00000000000011ea <printf>:

void
printf(const char *fmt, ...)
{
    11ea:	711d                	add	sp,sp,-96
  ...
  va_start(ap, fmt);
    1204:	00840613          	add	a2,s0,8
    1208:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    120c:	85aa                	mv	a1,a0
    120e:	4505                	li	a0,1
    1210:	00000097          	auipc	ra,0x0
    1214:	de0080e7          	jalr	-544(ra) # ff0 <vprintf>
}
    1218:	60e2                	ld	ra,24(sp)
    121a:	6442                	ld	s0,16(sp)
    121c:	6125                	add	sp,sp,96
    121e:	8082                	ret

0000000000001220 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    1220:	1141                	add	sp,sp,-16
    1222:	e422                	sd	s0,8(sp)
    1224:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    1226:	ff050693          	add	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    122a:	00001797          	auipc	a5,0x1
    122e:	de67b783          	ld	a5,-538(a5) # 2010 <freep>
    1232:	a02d                	j	125c <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    1234:	4618                	lw	a4,8(a2)
    1236:	9f2d                	addw	a4,a4,a1
    1238:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    123c:	6398                	ld	a4,0(a5)
    123e:	6310                	ld	a2,0(a4)
    1240:	a83d                	j	127e <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    1242:	ff852703          	lw	a4,-8(a0)
    1246:	9f31                	addw	a4,a4,a2
    1248:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    124a:	ff053683          	ld	a3,-16(a0)
    124e:	a091                	j	1292 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1250:	6398                	ld	a4,0(a5)
    1252:	00e7e463          	bltu	a5,a4,125a <free+0x3a>
    1256:	00e6ea63          	bltu	a3,a4,126a <free+0x4a>
{
    125a:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    125c:	fed7fae3          	bgeu	a5,a3,1250 <free+0x30>
    1260:	6398                	ld	a4,0(a5)
    1262:	00e6e463          	bltu	a3,a4,126a <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1266:	fee7eae3          	bltu	a5,a4,125a <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    126a:	ff852583          	lw	a1,-8(a0)
    126e:	6390                	ld	a2,0(a5)
    1270:	02059813          	sll	a6,a1,0x20
    1274:	01c85713          	srl	a4,a6,0x1c
    1278:	9736                	add	a4,a4,a3
    127a:	fae60de3          	beq	a2,a4,1234 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    127e:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    1282:	4790                	lw	a2,8(a5)
    1284:	02061593          	sll	a1,a2,0x20
    1288:	01c5d713          	srl	a4,a1,0x1c
    128c:	973e                	add	a4,a4,a5
    128e:	fae68ae3          	beq	a3,a4,1242 <free+0x22>
    p->s.ptr = bp->s.ptr;
...
malloc(uint nbytes)
{
    ...
    12b4:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    12b6:	02051493          	sll	s1,a0,0x20
    12ba:	9081                	srl	s1,s1,0x20
    12bc:	04bd                	add	s1,s1,15
    12be:	8091                	srl	s1,s1,0x4
    12c0:	0014899b          	addw	s3,s1,1
    12c4:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12f2:	d2290913          	add	s2,s2,-734 # 2010 <freep>
  if(p == (char*)-1)
    12f6:	5afd                	li	s5,-1
    12f8:	a895                	j	136c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    12fa:	00001797          	auipc	a5,0x1
    12fe:	d8e78793          	add	a5,a5,-626 # 2088 <base>
    ...
    131a:	c798                	sw	a4,8(a5)
        p += p->s.size;
    131c:	02071693          	sll	a3,a4,0x20
    1320:	01c6d713          	srl	a4,a3,0x1c
    1324:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    1326:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    132a:	00001717          	auipc	a4,0x1
    132e:	cea73323          	sd	a0,-794(a4) # 2010 <freep>
      return (void*)(p + 1);
    1332:	01078513          	add	a0,a5,16
  ...
  free((void*)(hp + 1));
    1354:	0541                	add	a0,a0,16
    1356:	00000097          	auipc	ra,0x0
    135a:	eca080e7          	jalr	-310(ra) # 1220 <free>
  return freep;
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    137c:	b42080e7          	jalr	-1214(ra) # eba <sbrk>
  if(p == (char*)-1)
...
void init_lock(){
    1388:	1141                	add	sp,sp,-16
    138a:	e406                	sd	ra,8(sp)
    138c:	e022                	sd	s0,0(sp)
    138e:	0800                	add	s0,sp,16
    initlock(&list_lock);
    1390:	00001517          	auipc	a0,0x1
    1394:	c8850513          	add	a0,a0,-888 # 2018 <list_lock>
    1398:	00000097          	auipc	ra,0x0
    139c:	a56080e7          	jalr	-1450(ra) # dee <initlock>
}
    13a0:	60a2                	ld	ra,8(sp)
    13a2:	6402                	ld	s0,0(sp)
    13a4:	0141                	add	sp,sp,16
    13a6:	8082                	ret

00000000000013a8 <insert>:

// Function to insert a node at the beginning of the linked list
void insert(struct Node **head_ref, int new_data) {
    13a8:	1101                	add	sp,sp,-32
    13aa:	ec06                	sd	ra,24(sp)
    13ac:	e822                	sd	s0,16(sp)
    13ae:	e426                	sd	s1,8(sp)
    13b0:	e04a                	sd	s2,0(sp)
    13b2:	1000                	add	s0,sp,32
    13b4:	84aa                	mv	s1,a0
    13b6:	892e                	mv	s2,a1
    struct Node *new_node = malloc(sizeof(struct Node));
    13b8:	4541                	li	a0,16
    13ba:	00000097          	auipc	ra,0x0
    13be:	ee8080e7          	jalr	-280(ra) # 12a2 <malloc>
    new_node->data = new_data;
    13c2:	01252023          	sw	s2,0(a0)
    new_node->next = *head_ref;
    13c6:	609c                	ld	a5,0(s1)
    13c8:	e51c                	sd	a5,8(a0)
    *head_ref = new_node;
    13ca:	e088                	sd	a0,0(s1)
}
    13cc:	60e2                	ld	ra,24(sp)
    13ce:	6442                	ld	s0,16(sp)
    13d0:	64a2                	ld	s1,8(sp)
    13d2:	6902                	ld	s2,0(sp)
    13d4:	6105                	add	sp,sp,32
    13d6:	8082                	ret

00000000000013d8 <deleteNode>:

// Function to delete a node with a given key from the linked list
void deleteNode(struct Node **head_ref, int key) {
    13d8:	7179                	add	sp,sp,-48
    13da:	f406                	sd	ra,40(sp)
    13dc:	f022                	sd	s0,32(sp)
    13de:	ec26                	sd	s1,24(sp)
    13e0:	e84a                	sd	s2,16(sp)
    13e2:	e44e                	sd	s3,8(sp)
    13e4:	1800                	add	s0,sp,48
    13e6:	89aa                	mv	s3,a0
    13e8:	892e                	mv	s2,a1
    struct Node *temp = *head_ref, *prev = 0;
    13ea:	6104                	ld	s1,0(a0)

    acquire(&list_lock);
    13ec:	00001517          	auipc	a0,0x1
    13f0:	c2c50513          	add	a0,a0,-980 # 2018 <list_lock>
    13f4:	00000097          	auipc	ra,0x0
    13f8:	a0a080e7          	jalr	-1526(ra) # dfe <acquire>
    if (temp != 0 && temp->data == key) {
    13fc:	c0b1                	beqz	s1,1440 <deleteNode+0x68>
    13fe:	409c                	lw	a5,0(s1)
    1400:	4701                	li	a4,0
    1402:	01278a63          	beq	a5,s2,1416 <deleteNode+0x3e>
        rcusync();
        free(temp);
        return;
    }
    ...
    1408:	05278563          	beq	a5,s2,1452 <deleteNode+0x7a>
        prev = temp;
        temp = temp->next;
    140c:	649c                	ld	a5,8(s1)
    while (temp != 0 && temp->data != key) {
    140e:	8726                	mv	a4,s1
    1410:	cb85                	beqz	a5,1440 <deleteNode+0x68>
        temp = temp->next;
    1412:	84be                	mv	s1,a5
    1414:	bfcd                	j	1406 <deleteNode+0x2e>
        *head_ref = temp->next;
    1416:	649c                	ld	a5,8(s1)
    1418:	00f9b023          	sd	a5,0(s3)
        release(&list_lock);
    141c:	00001517          	auipc	a0,0x1
    1420:	bfc50513          	add	a0,a0,-1028 # 2018 <list_lock>
    1424:	00000097          	auipc	ra,0x0
    1428:	9f2080e7          	jalr	-1550(ra) # e16 <release>
        rcusync();
    142c:	00000097          	auipc	ra,0x0
    1430:	ab6080e7          	jalr	-1354(ra) # ee2 <rcusync>
        free(temp);
    1434:	8526                	mv	a0,s1
    1436:	00000097          	auipc	ra,0x0
    143a:	dea080e7          	jalr	-534(ra) # 1220 <free>
        return;
    143e:	a82d                	j	1478 <deleteNode+0xa0>
    }

    if (temp == 0) {
        release(&list_lock);
    1440:	00001517          	auipc	a0,0x1
    1444:	bd850513          	add	a0,a0,-1064 # 2018 <list_lock>
    1448:	00000097          	auipc	ra,0x0
    144c:	9ce080e7          	jalr	-1586(ra) # e16 <release>
        return;
    1450:	a025                	j	1478 <deleteNode+0xa0>
    }
    prev->next = temp->next;
    1452:	649c                	ld	a5,8(s1)
    1454:	e71c                	sd	a5,8(a4)
    release(&list_lock);
    1456:	00001517          	auipc	a0,0x1
    145a:	bc250513          	add	a0,a0,-1086 # 2018 <list_lock>
    145e:	00000097          	auipc	ra,0x0
    1462:	9b8080e7          	jalr	-1608(ra) # e16 <release>
    rcusync();
    1466:	00000097          	auipc	ra,0x0
    146a:	a7c080e7          	jalr	-1412(ra) # ee2 <rcusync>
    free(temp);
    146e:	8526                	mv	a0,s1
    1470:	00000097          	auipc	ra,0x0
    1474:	db0080e7          	jalr	-592(ra) # 1220 <free>
}
    1478:	70a2                	ld	ra,40(sp)
    147a:	7402                	ld	s0,32(sp)
    147c:	64e2                	ld	s1,24(sp)
    147e:	6942                	ld	s2,16(sp)
    1480:	69a2                	ld	s3,8(sp)
    1482:	6145                	add	sp,sp,48
    1484:	8082                	ret

0000000000001486 <search>:

// Function to search for a node with a given key in the linked list
struct Node* search(struct Node *head, int key) {
    1486:	1101                	add	sp,sp,-32
    1488:	ec06                	sd	ra,24(sp)
    148a:	e822                	sd	s0,16(sp)
    148c:	e426                	sd	s1,8(sp)
    148e:	e04a                	sd	s2,0(sp)
    1490:	1000                	add	s0,sp,32
    1492:	84aa                	mv	s1,a0
    1494:	892e                	mv	s2,a1
    ...
    149a:	a3c080e7          	jalr	-1476(ra) # ed2 <rcureadlock>
    while (current != 0) {
    149e:	c491                	beqz	s1,14aa <search+0x24>
        if (current->data == key) {
    14a0:	409c                	lw	a5,0(s1)
    14a2:	01278f63          	beq	a5,s2,14c0 <search+0x3a>
            rcureadunlock();
            return current; // Node found
        }
        current = current->next;
    14a6:	6484                	ld	s1,8(s1)
    while (current != 0) {
    14a8:	fce5                	bnez	s1,14a0 <search+0x1a>
    }
    rcureadunlock();
    14aa:	00000097          	auipc	ra,0x0
    14ae:	a30080e7          	jalr	-1488(ra) # eda <rcureadunlock>
    return 0; // Node not found
    14b2:	4501                	li	a0,0
}
    14b4:	60e2                	ld	ra,24(sp)
    14b6:	6442                	ld	s0,16(sp)
    14b8:	64a2                	ld	s1,8(sp)
    14ba:	6902                	ld	s2,0(sp)
    14bc:	6105                	add	sp,sp,32
    14be:	8082                	ret
            rcureadunlock();
    14c0:	00000097          	auipc	ra,0x0
    14c4:	a1a080e7          	jalr	-1510(ra) # eda <rcureadunlock>
            return current; // Node found
    14c8:	8526                	mv	a0,s1
    14ca:	b7ed                	j	14b4 <search+0x2e>

00000000000014cc <updateNode>:
...
void updateNode(struct Node *head, int key, int new_data) {
    14cc:	1101                	add	sp,sp,-32
    14ce:	ec06                	sd	ra,24(sp)
    14d0:	e822                	sd	s0,16(sp)
    14d2:	e426                	sd	s1,8(sp)
    14d4:	e04a                	sd	s2,0(sp)
    14d6:	1000                	add	s0,sp,32
    14d8:	892e                	mv	s2,a1
    14da:	84b2                	mv	s1,a2
    struct Node *nodeToUpdate = search(head, key);
    14dc:	00000097          	auipc	ra,0x0
    14e0:	faa080e7          	jalr	-86(ra) # 1486 <search>

    if (nodeToUpdate != 0) {
    14e4:	c901                	beqz	a0,14f4 <updateNode+0x28>
        nodeToUpdate->data = new_data; // Update the node's data
    14e6:	c104                	sw	s1,0(a0)
    } else {
    ...
    14ec:	64a2                	ld	s1,8(sp)
    14ee:	6902                	ld	s2,0(sp)
    14f0:	6105                	add	sp,sp,32
    14f2:	8082                	ret
        printf("Node with key %d not found.\n", key);
    14f4:	85ca                	mv	a1,s2
    14f6:	00000517          	auipc	a0,0x0
    14fa:	1d250513          	add	a0,a0,466 # 16c8 <digits+0x18>
    14fe:	00000097          	auipc	ra,0x0
    1502:	cec080e7          	jalr	-788(ra) # 11ea <printf>
}
    1506:	b7cd                	j	14e8 <updateNode+0x1c>
